...
public class ArtistSharesDto {
    ...
    public ArtistSharesDto(String artistId, String artistName, String spotifyUrl,
                           ...
                           BigDecimal currentPrice, BigDecimal priceChangePercent,
    ...
    // Getters / Setters for BigDecimal
    ...
    public int getAirdropSupply() { return airdropSupply; }
    public void setAirdropSupply(int airdropSupply) { this.airdropSupply = airdropSupply; }

    // Mapper: Artist → DTO (BigDecimal safe)
    public static ArtistSharesDto fromArtist(Artist artist) {
        return new ArtistSharesDto(
            ...
            artist.getCurrentPrice() != null ? artist.getCurrentPrice() : BigDecimal.ZERO,
            artist.getPriceChangePercent() != null ? artist.getPriceChangePercent() : BigDecimal.ZERO,
